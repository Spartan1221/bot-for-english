...
2. Отправьте слово `serendipity` — должен прийти ответ из двух строк, а под ним две кнопки: «📋 Слово + пример» и «📋 Значение + перевод». Тап по кнопке копирует соответствующую строку ответа в буфер обмена.
